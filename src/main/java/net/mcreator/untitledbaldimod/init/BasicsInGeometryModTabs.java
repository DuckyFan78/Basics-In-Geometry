...
public class BasicsInGeometryModTabs {
	...
	public static final RegistryObject<CreativeModeTab> UNTITLED_BALDI_MOD = REGISTRY.register("untitled_baldi_mod",
			() -> CreativeModeTab.builder().title(Component.translatable("item_group.basics_in_geometry.untitled_baldi_mod")).icon(() -> new ItemStack(BasicsInGeometryModBlocks.SCHOOLHOUSE_WALL_1.get())).displayItems((parameters, tabData) -> {
